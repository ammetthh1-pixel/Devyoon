/* ══════════════════════════════════════════════
   DEVYOON — Configuration des projets IA
   Un seul éditeur (editor-ia.html) pour toutes les
   phases. Chaque entrée définit une liste de scripts
   (un projet peut en avoir un seul ou plusieurs).
...
`,
  ...
  // Prochaine entrée à ajouter ici : "01": { ... } pour la Phase 01, etc.
};
